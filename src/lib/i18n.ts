...
const en = {
  ...
  pin: {
    ...
    pinMinDigits: "PIN must be exactly 4 digits",
  ...
  onboarding: {
    ...
    subtitleStep1: "Set up your account to get started.",
    accountSetup: "Your Account",
    accountSetupHint: "Enter your name and choose a 4-digit PIN for the POS.",
    ownerName: "Your Name",
...
const ar: DeepStringify<typeof en> = {
  ...
  pin: {
    ...
    pinMinDigits: "يجب أن يكون الرمز 4 أرقام بالضبط",
  ...
  customers: {
    ...
    outstandingBalance: "المبلغ المستحق",
    paymentDate: "التاريخ",
    paymentFor: "للطلب",
  ...
  onboarding: {
    ...
    subtitleStep1: "أعدّ حسابك للبدء.",
    accountSetup: "حسابك",
    accountSetupHint: "أدخل اسمك واختر رمز PIN من 4 أرقام لنقطة البيع.",
    ownerName: "اسمك",
